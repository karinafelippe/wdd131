...
const namesN = ["JC63", "Bob132", "Ursula89", "Ben96"];
const greatIDs = namesN
...
// BYU Answer: let namesB = names.filter(name => name.charAt(0) === 'B');
